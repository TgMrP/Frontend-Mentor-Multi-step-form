...
<template>
  <div
    class="flex h-full w-full flex-col items-center justify-center gap-6 py-14 lg:py-0"
  >
    <svg
    ...
    <!--  -->
    <div class="">
      <h1 class="text-center text-3xl font-bold text-marine">Thank you!</h1>
      <div class="px-2 pt-2 text-center text-gray lg:max-w-[50ch]">
